function collision_free_flag = checkCollisionAlongPath_v2(occMap, startState, direction, params)
    ...
    for i = 1:size(disc_points_box, 1)
        ...
        [intersection, ~] = rayIntersection(occMap, [startState.' + offset, 1, zeros(1,3)], direction.', params.camMaxRange + 1/params.mapResolution, false);
